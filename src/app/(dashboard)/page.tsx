...
import {
    ...
    BarChart2, BrainCircuit, Bell, Clock, CalendarDays,
...
function getRiskLevel(predictedDeath: number) {
    ...
    if (predictedDeath <= 3) return { label: "Waspada", variant: "warning" as const, color: "text-yellow-600", bg: "bg-yellow-50 border-yellow-100" };
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                    ...
                    <div className="p-4">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <span className="text-sm font-semibold text-gray-700">Prediksi Kematian 30 Menit</span>
                        </div>
                        {loadingPred ? (
                            <div className="h-10 bg-gray-50 animate-pulse rounded-lg" />
                        ) : latestForecast ? (
                            <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center gap-2">
                                    {(latestForecast.predicted_death ?? 0) === 0
                                        ? <CheckCircle2 className="w-7 h-7 text-green-500" />
                                        : (latestForecast.predicted_death ?? 0) <= 3
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <Link href="/sensor-data">
                                    <div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-emerald-50 hover:bg-emerald-100 transition-colors cursor-pointer text-center">
                                        <div className="p-2 rounded-lg bg-emerald-100 text-emerald-600"><BarChart2 className="w-4 h-4" /></div>
                                        <div><p className="text-xs font-semibold text-gray-800">Data Sensor</p><p className="text-[10px] text-gray-400 leading-tight mt-0.5">Riwayat IoT</p></div>
                                    </div>
                                </Link>
                                <Link href="/predictions">
                                    <div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-violet-50 hover:bg-violet-100 transition-colors cursor-pointer text-center">
                                        <div className="p-2 rounded-lg bg-violet-100 text-violet-600"><BrainCircuit className="w-4 h-4" /></div>
                                        <div><p className="text-xs font-semibold text-gray-800">Prediksi ML</p><p className="text-[10px] text-gray-400 leading-tight mt-0.5">Hasil otomatis</p></div>
                                    </div>
                                </Link>
                                <button onClick={() => setShowDeathModal(true)} className="w-full">
                                    <div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-red-50 hover:bg-red-100 transition-colors cursor-pointer text-center">
                                        <div className="p-2 rounded-lg bg-red-100 text-red-600"><HeartCrack className="w-4 h-4" /></div>
                                        <div><p className="text-xs font-semibold text-gray-800">Laporkan</p><p className="text-[10px] text-gray-400 leading-tight mt-0.5">Kematian</p></div>
                                    </div>
                                </button>
                                <button onClick={() => setShowDailyModal(true)} className="w-full">
                                    <div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-blue-50 hover:bg-blue-100 transition-colors cursor-pointer text-center">
                                        <div className="p-2 rounded-lg bg-blue-100 text-blue-600"><BookOpen className="w-4 h-4" /></div>
                                        <div><p className="text-xs font-semibold text-gray-800">Input Harian</p><p className="text-[10px] text-gray-400 leading-tight mt-0.5">Pakan & Minum</p></div>
                                    </div>
                                </button>
                            </div>
                        </CardContent>
